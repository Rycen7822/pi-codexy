...
export type WebSocketContinuationDecision = "disabled" | "no_session_cache_entry" | "no_continuation" | "body_mismatch" | "input_shorter_than_baseline" | "input_prefix_mismatch" | "missing_previous_response_id" | "delta";
export type CanonicalHistoryDecision = "compaction" | "identity_mismatch" | "input_shorter_than_baseline" | "request_prefix_mismatch" | "response_prefix_mismatch" | "validated";
...
export type CodexDiagnosticsFailureCategory = "aborted" | "authentication" | "connection" | "connection_limit" | "message_too_big" | "overload" | "previous_response_missing" | "protocol" | "rate_limit" | "timeout" | "transport" | "unknown";
...
export declare function createInitialAssistantMessage(model: {
    provider: string;
    id: string;
}): AssistantMessage;
