...
import { serializeActiveSessionToResponsesInput, } from "./serializer.js";
...
function buildCompactionTools(pi, codeMode) {
...
function buildCompactionRequestOptions(pi, ctx, state, compactionTargetModel, codeMode) {
