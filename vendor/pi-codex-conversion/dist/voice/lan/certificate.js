...
export async function resolveLanVoiceCertificate(agentDir) {
    const hostnames = [
...
function lanAddresses() {
    ...
    for (const [name, entries] of Object.entries(networkInterfaces())) {
        if (/^(?:br-|docker|veth|virbr)/.test(name))
            continue;
...
function certificateIsReusable(certPath, keyPath, metadataPath, identities) {
