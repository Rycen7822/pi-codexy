...
export interface ProgrammaticCodeModeToolDefinition extends CodeModeToolMetadata {
    ...
    renderCall?(input: unknown, theme: CodeModeRenderTheme, context: CodeModeNestedRenderContext): Component;
    renderResult?(result: RuntimeToolResult, options: {
        expanded: boolean;
        isPartial: boolean;
    }, theme: CodeModeRenderTheme, context: CodeModeNestedRenderContext): Component;
}
export type CodeModeToolDefinition = CustomToolDefinition | ProgrammaticCodeModeToolDefinition;
