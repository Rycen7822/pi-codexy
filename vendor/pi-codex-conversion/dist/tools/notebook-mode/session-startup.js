...
import { notebookExecStartupNotice } from "./control-contract.js";
import { garbageCollectSupersededNotebookCheckpoints, restoreNotebookCheckpoint, } from "./checkpoint.js";
import { ensureNotebookDenoBinary } from "./deno-binary.js";
import { initializeNotebookJournal } from "./journal.js";
import { DenoJupyterKernel } from "./jupyter-kernel.js";
import { notebookBootstrapSource, notebookExampleSource } from "./kernel-runtime.js";
import { formatNotebookNpmImportsNotice, readNotebookNpmImports } from "./npm-imports.js";
import { formatProjectStateNotice, restoreProjectState, } from "./project-state.js";
...
async function installNotebookExamples(kernel, signal) {
