import { hashStateBytes, MAX_PROJECT_ENTRIES, } from "./project-state-format.js";
export function mergeProjectState(options) {
    ...
    if (options.pins) {
        ...
        if (missing.length > 0)
            throw new Error(`Durable notebook bindings not found: ${missing.join(", ")}`);
...
function projectStateEntryShape(entry) {
