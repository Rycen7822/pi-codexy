...
export async function extractDenoArchive(archive, asset) {
    const invalid = () => new Error(`unsupported pinned Deno archive layout: ${asset.archive}`);
    const end = archive.length - 22;
    if (end < 30 || archive.readUInt32LE(end) !== 0x06054b50)
        throw invalid();
    ...
    if (directory < 30 ||
        ...
        directoryBytes < 46)
        throw invalid();
    if (archive.readUInt32LE(directory) !== 0x02014b50 ||
