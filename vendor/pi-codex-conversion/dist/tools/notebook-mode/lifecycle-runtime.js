export function notebookStatusSource(names, marker) {
...
export function notebookReleaseSource(names, marker) {
    return notebookDisposalSource(names, marker, true);
}
export function notebookDisposeSource(names, marker) {
    return notebookDisposalSource(names, marker, false);
}
function notebookDisposalSource(names, marker, remove) {
...
export function parseNotebookRuntimeResult(result, marker) {
    if (result.status !== "ok")
        throw new Error(result.errorText ?? "Notebook lifecycle operation failed");
    ...
    if (start === -1)
        throw new Error("Notebook lifecycle operation returned no result");
